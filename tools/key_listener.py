# ВНИМАНИЕ: Этот скрипт больше не используется!
# UDP сервер на бэкенде отключен, хендлинг нажатий клавиш не нужен.
# Если вы запустили этот скрипт, остановите его (Ctrl+C).
